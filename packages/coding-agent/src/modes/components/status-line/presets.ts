...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["pi", "model", "plan_mode", "ask_mode", "debug_mode", "path", "git", "pr", "context_pct", "token_total", "cost"],
		rightSegments: [],
	...
	minimal: {
		...
		rightSegments: ["plan_mode", "ask_mode", "debug_mode", "context_pct"],
		separator: "slash",
		segmentOptions: {
	...
	compact: {
		leftSegments: ["model", "plan_mode", "ask_mode", "debug_mode", "git", "pr"],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "plan_mode", "ask_mode", "debug_mode", "path", "git", "pr", "subagents"],
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "plan_mode", "ask_mode", "debug_mode", "path", "git", "pr", "session", "subagents"],
		rightSegments: [
			"token_in",
			"token_out",
			"cache_read",
	...
	ascii: {
		...
		leftSegments: ["model", "plan_mode", "ask_mode", "debug_mode", "path", "git", "pr"],
