...
/** @deprecated Use {@link parsePatch}. */
export function parseHashline(diff: string): any {
	return parsePatch(diff).edits;
}

/** @deprecated Use {@link parsePatchStreaming}. */
export function parseHashlineWithWarnings(diff: string): any {
